                ...
                if (doc.exists()) {
                    ...
                    for (let i = 1; i <= numberOfTables; i++) {
                        ...
                        qrCode.innerHTML = `
                            ...
                            <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://jayeshr1204.github.io/DineHub/public/customer/?RestId=${userId}@table=0${i}" alt="QR Code">
                            <p>Table ${i}</p>
                        `;
